      ...
      <div>
        {
          doctors.slice(0,2).map((item,index)=>(
            <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
              <div>
                <img className='w-36 bg-violet-500' src={item.image} alt="" />
              </div>
              <div className='flex-1 text-sm text-zinc-600'>
                ...
                <p className='text-xs mt-1 ' ><span className='text-sm font-bold'>date and time : </span>25 june 2024  | 10.00am</p>
              </div>
              <div>
